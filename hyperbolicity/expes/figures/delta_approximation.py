...
plt.tight_layout()
tikzplotlib.save("/share/home/houedry/projects/DifferentiableHyperbolicity/hyperbolicity/expes/results_expes/delta_scale_plot.tex")
plt.savefig("/share/home/houedry/projects/DifferentiableHyperbolicity/hyperbolicity/expes/results_expes/delta_scale_plot.png", dpi=300)
plt.show()
...
plt.grid(True, which="both", linestyle='--', linewidth=0.5)
plt.tight_layout()
tikzplotlib.save("/share/home/houedry/projects/DifferentiableHyperbolicity/hyperbolicity/expes/results_expes/hyperbolicity_batches_plot.tex")
plt.savefig("/share/home/houedry/projects/DifferentiableHyperbolicity/hyperbolicity/expes/results_expes/hyperbolicity_batches_plot.png", dpi=300)
plt.show()
